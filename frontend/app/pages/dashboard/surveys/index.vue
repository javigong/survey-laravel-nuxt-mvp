        ...
        <div v-else class="bg-white dark:bg-gray-800 shadow rounded-lg">
          ...
          >
            <thead class="bg-gray-50 dark:bg-gray-700">
              <tr>
                <th
                  class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider min-w-0 w-80 max-w-80"
                >
                  Title
                </th>
                <th
            ...
            >
              <tr v-for="survey in surveys" :key="survey.id">
                <td class="px-6 py-4 min-w-0 w-80 max-w-80">
                  <div class="min-w-0">
                    <div
                      class="text-sm font-medium text-gray-900 dark:text-white truncate max-w-full"
                      :title="survey.title"
                    >
                      {{ survey.title }}
                    </div>
                    <div
                      ...
                      class="text-sm text-gray-500 dark:text-gray-400 truncate max-w-full"
                  ...
                  <div class="min-w-0">
                    ...
                    >
                      <div class="flex flex-wrap gap-1">
                        <span
                          v-for="question in survey.questions.slice(0, 2)"
                          :key="question.id"
                          class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400 truncate"
                          :title="question.type_display"
                        >
                          {{ getQuestionTypeIcon(question.type) }}
                          {{ question.type_display }}
                        </span>
                        <span
                          v-if="survey.questions.length > 2"
